...
public static class LeanTweenExt
{
    ...
    public static LTDescr LeanSRColor(this SpriteRenderer sr, Color to, float time) { return LeanTween.LeanSRCol(sr,to,time);}
    public static LTDescr LeanImgColor(this Image img, Color to, float time) { return LeanTween.LeanImgCol(img,to,time);}
