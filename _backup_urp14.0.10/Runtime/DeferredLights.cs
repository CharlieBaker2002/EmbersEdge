...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class DeferredLights
    {
        ...
        internal UnityEngine.Rendering.RenderGraphModule.TextureHandle[] GbufferTextureHandles { get; set; }
        ...
        internal void CreateGbufferResources()
        {
            ...
            if (this.GbufferRTHandles == null || this.GbufferRTHandles.Length != gbufferSliceCount)
            {
                ...
                this.GbufferTextureHandles = new UnityEngine.Rendering.RenderGraphModule.TextureHandle[gbufferSliceCount];
