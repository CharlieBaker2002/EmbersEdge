...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class XROcclusionMeshPass : ScriptableRenderPass
    {
        ...
        private class PassData
        {
            ...
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraColorAttachment;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepthAttachment;
            internal bool isActiveTargetBackBuffer;
        }

        internal void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, in UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraColorAttachment, in UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepthAttachment, ref RenderingData renderingData)
        {
            using (var builder = renderGraph.AddRenderPass<PassData>("XR Occlusion Pass", out var passData, base.profilingSampler))
            {
                ...
                passData.cameraDepthAttachment = builder.UseDepthBuffer(cameraDepthAttachment, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
