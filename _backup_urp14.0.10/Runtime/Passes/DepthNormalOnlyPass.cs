...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class DepthNormalOnlyPass : ScriptableRenderPass
    {
        ...
        internal void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, out UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraNormalsTexture, out UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepthTexture, ref RenderingData renderingData)
        {
            ...
            using (var builder = renderGraph.AddRenderPass<PassData>("DepthNormals Prepass", out var passData, base.profilingSampler))
            {
                ...
                passData.cameraDepthTexture = builder.UseDepthBuffer(cameraDepthTexture, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
