...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class GBufferPass : ScriptableRenderPass
    {
        ...
        internal void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraColor, UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepth,
            ref RenderingData renderingData, ref UniversalRenderer.RenderGraphFrameResources frameResources)
        {
            using (var builder = renderGraph.AddRenderPass<PassData>("GBuffer Pass", out var passData, m_ProfilingSampler))
            {
                ...
                passData.depth = builder.UseDepthBuffer(cameraDepth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
            ...
            using (var builder = renderGraph.AddRenderPass<PassData>("Set GBuffer Globals", out var passData, m_ProfilingSampler))
            {
                ...
                passData.depth = builder.UseDepthBuffer(cameraDepth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Read);
                passData.renderingData = renderingData;
                passData.deferredLights = m_DeferredLights;
