...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    public class RenderObjectsPass : ScriptableRenderPass
    {
        ...
        internal override void RecordRenderGraph(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData)
        {
            ...
            {
                UnityEngine.Rendering.RenderGraphModule.TextureHandle color = UniversalRenderer.m_ActiveRenderGraphColor;
                builder.UseColorBuffer(color, 0);
                builder.UseDepthBuffer(UniversalRenderer.m_ActiveRenderGraphDepth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
