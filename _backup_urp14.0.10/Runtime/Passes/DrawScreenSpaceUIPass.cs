...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal class DrawScreenSpaceUIPass : ScriptableRenderPass
    {
        ...
        private class PassData
        {
            ...
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle offscreenTexture;
        }
        ...
        //RenderGraph path
        internal void RenderOffscreen(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, int depthBufferBits, out UnityEngine.Rendering.RenderGraphModule.TextureHandle output, ref RenderingData renderingData)
        {
            using (var builder = renderGraph.AddRenderPass<PassData>("Draw Screen Space UI Pass - Offscreen", out var passData, base.profilingSampler))
            {
                ...
                UnityEngine.Rendering.RenderGraphModule.TextureHandle depthBuffer = UniversalRenderer.CreateRenderGraphTexture(renderGraph, depthDescriptor, "_OverlayUITexture_Depth", false);
                builder.UseDepthBuffer(depthBuffer, UnityEngine.Rendering.RenderGraphModule.DepthAccess.ReadWrite);
        ...
        internal void RenderOverlay(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, in UnityEngine.Rendering.RenderGraphModule.TextureHandle colorBuffer, in UnityEngine.Rendering.RenderGraphModule.TextureHandle depthBuffer, ref RenderingData renderingData)
        {
