...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class DrawObjectsPass : ScriptableRenderPass
    {
        ...
        {
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle m_Albedo;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle m_Depth;
        ...
        internal void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, UnityEngine.Rendering.RenderGraphModule.TextureHandle colorTarget, UnityEngine.Rendering.RenderGraphModule.TextureHandle depthTarget, UnityEngine.Rendering.RenderGraphModule.TextureHandle mainShadowsTexture, UnityEngine.Rendering.RenderGraphModule.TextureHandle additionalShadowsTexture, ref RenderingData renderingData)
        {
            Camera camera = renderingData.cameraData.camera;
                ...
                m_ProfilingSampler))
            {
                ...
                passData.m_Depth = builder.UseDepthBuffer(depthTarget, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
