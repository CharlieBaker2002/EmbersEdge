...
namespace UnityEngine.Rendering.Universal
{
    sealed class MotionVectorRenderPass : ScriptableRenderPass
    {
        ...
        internal void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepthTexture, in UnityEngine.Rendering.RenderGraphModule.TextureHandle motionVectorColor, in UnityEngine.Rendering.RenderGraphModule.TextureHandle motionVectorDepth, ref RenderingData renderingData)
        {
            using (var builder = renderGraph.AddRenderPass<PassData>("Motion Vector Pass", out var passData, base.profilingSampler))
            {
                ...
                passData.motionVectorDepth = builder.UseDepthBuffer(motionVectorDepth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
