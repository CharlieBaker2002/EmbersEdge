...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public partial class AdditionalLightsShadowCasterPass : ScriptableRenderPass
    {
        ...
        private class PassData
        {
            ...
            internal UnityEngine.Rendering.RenderGraphModule.RenderGraph graph;

            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle shadowmapTexture;
        ...
        internal UnityEngine.Rendering.RenderGraphModule.TextureHandle Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph graph, ref RenderingData renderingData)
        {
            UnityEngine.Rendering.RenderGraphModule.TextureHandle shadowTexture;
            ...
            using (var builder = graph.AddRenderPass<PassData>("Additional Lights Shadowmap", out var passData, base.profilingSampler))
            {
                ...
                if (!m_CreateEmptyShadowmap)
                {
                    ...
                    builder.UseDepthBuffer(passData.shadowmapTexture, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
                }
            ...
            using (var builder = graph.AddRenderPass<PassData>("Set Additional Shadow Globals", out var passData, base.profilingSampler))
            {
                ...
                if (shadowTexture.IsValid())
                    builder.UseDepthBuffer(shadowTexture, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Read);
        ...
        void InitPassData(ref PassData passData, ref RenderingData renderingData, ref UnityEngine.Rendering.RenderGraphModule.RenderGraph graph)
        {
            passData.pass = this;
