...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderer
    {
        ...
        static internal UnityEngine.Rendering.RenderGraphModule.TextureHandle m_ActiveRenderGraphColor;
        static internal UnityEngine.Rendering.RenderGraphModule.TextureHandle m_ActiveRenderGraphDepth;
        internal bool m_TargetIsBackbuffer;

        internal class RenderGraphFrameResources
        {
            // backbuffer
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle backBufferColor;
            //internal TextureHandle backBufferDepth;

            // intermediate camera targets
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraColor;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepth;

            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle mainShadowsTexture;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle additionalShadowsTexture;

            // gbuffer targets

            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle[] gbuffer;

            // camear opaque/depth/normal
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraOpaqueTexture;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraDepthTexture;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle cameraNormalsTexture;

            // motion vector
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle motionVectorColor;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle motionVectorDepth;

            // postFx
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle internalColorLut;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle overlayUITexture;
        };
        ...
        internal static UnityEngine.Rendering.RenderGraphModule.TextureHandle CreateRenderGraphTexture(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, RenderTextureDescriptor desc, string name, bool clear,
        ...
        void CreateRenderGraphCameraRenderTargets(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        ...
        internal override void OnRecordRenderGraph(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        ...
        private void OnBeforeRendering(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        ...
        private void OnMainRendering(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        ...
        private void OnAfterRendering(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
    ...
    class ClearTargetsPass
    {
        ...
        internal static void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph graph, UniversalRenderer renderer, RTClearFlags clearFlags, Color clearColor)
        {
            using (var builder = graph.AddRenderPass<PassData>("Clear Targets Pass", out var passData, s_ClearProfilingSampler))
            {
                ...
                passData.depth = builder.UseDepthBuffer(UniversalRenderer.m_ActiveRenderGraphDepth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Write);
