...
namespace UnityEngine.Rendering.Universal
{
    ...
    static class TemporalAA
    {
        ...
        {
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle dstTex;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle srcColorTex;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle srcDepthTex;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle srcMotionVectorTex;
            internal UnityEngine.Rendering.RenderGraphModule.TextureHandle srcTaaAccumTex;
        ...
        internal static void Render(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, Material taaMaterial, ref CameraData cameraData, ref UnityEngine.Rendering.RenderGraphModule.TextureHandle srcColor, ref UnityEngine.Rendering.RenderGraphModule.TextureHandle srcDepth, ref UnityEngine.Rendering.RenderGraphModule.TextureHandle srcMotionVectors, ref UnityEngine.Rendering.RenderGraphModule.TextureHandle dstColor)
        {
            int multipassId = 0;
#if ENABLE_VR && ENABLE_XR_MODULE
            multipassId = cameraData.xr.multipassId;
            ...
            UnityEngine.Rendering.RenderGraphModule.TextureHandle srcAccumulation = renderGraph.ImportTexture(accumulationTexture);
            ...
            UnityEngine.Rendering.RenderGraphModule.TextureHandle activeMotionVectors = isNewFrame ? srcMotionVectors : renderGraph.defaultResources.blackTexture;
            ...
            using (var builder = renderGraph.AddRenderPass<TaaPassData>("Temporal Anti-aliasing", out var passData, ProfilingSampler.Get(URPProfileId.TemporalAA)))
            {
                ...
                builder.SetRenderFunc((TaaPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext context) =>
                {
            ...
            if (isNewFrame)
            {
                ...
                using (var builder = renderGraph.AddRenderPass<TaaPassData>("Temporal Anti-aliasing Copy History", out var passData, new ProfilingSampler("TemporalAAHistoryCopy")))
                {
                    ...
                    builder.SetRenderFunc((TaaPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext context) => { Blitter.BlitTexture(context.cmd, data.srcColorTex, Vector2.one, data.material, data.passIndex); });
                }
            }
        }
    }
