...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
        ...
        /// <param name="context">Use this render context to issue any draw commands during execution.</param>
        /// <param name="renderingData">Current render state information.</param>
        internal virtual void OnRecordRenderGraph(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        }

        private void InitRenderGraphFrame(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData)
        {
        ...
        internal void ProcessVFXCameraCommand(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData)
        {
                       ...
                       Profiling.vfxProcessCamera))
            {
                ...
                builder.SetRenderFunc((VFXProcessCameraPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext context) =>
                {
        ...
        internal void SetupRenderGraphCameraProperties(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData, bool isTargetBackbuffer)
        {
        ...
        internal void DrawRenderGraphGizmos(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, UnityEngine.Rendering.RenderGraphModule.TextureHandle color, UnityEngine.Rendering.RenderGraphModule.TextureHandle depth, GizmoSubset gizmoSubset, ref RenderingData renderingData)
        {
                ...
                Profiling.drawGizmos))
            {
                ...
                builder.UseDepthBuffer(depth, UnityEngine.Rendering.RenderGraphModule.DepthAccess.Read);
                ...
                builder.SetRenderFunc((DrawGizmosPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext rgContext) =>
                {
        ...
        private void BeginRenderGraphXRRendering(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData)
        {
#if ENABLE_VR && ENABLE_XR_MODULE
                ...
                Profiling.beginXRRendering))
            {
                ...
                builder.SetRenderFunc((BeginXRPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext context) =>
                {
        ...
        private void EndRenderGraphXRRendering(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ref RenderingData renderingData)
        {
#if ENABLE_VR && ENABLE_XR_MODULE
                ...
                Profiling.endXRRendering))
            {
                ...
                builder.SetRenderFunc((EndXRPassData data, UnityEngine.Rendering.RenderGraphModule.RenderGraphContext context) =>
                {
                    var cameraData = data.cameraData;
                    var cmd = data.renderingData.commandBuffer;
                    if (cameraData.xr.enabled)
        ...
        /// <param name="renderingData"></param>
        internal void RecordRenderGraph(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData)
        {
        ...
        internal void RecordCustomRenderGraphPasses(UnityEngine.Rendering.RenderGraphModule.RenderGraph renderGraph, ScriptableRenderContext context, ref RenderingData renderingData, RenderPassEvent injectionPoint)
        {
